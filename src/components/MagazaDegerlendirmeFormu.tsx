...
// DegerlendirmeFormu.tsx'in magaza-bazli ikizi - ayni desen (form-modal + POST
// + basari ekrani), sadece hedef urun degil magaza. Bu modal /rezervasyonum
// sayfasinda SADECE bu magazadan gercekten satin almis kullaniciya gosterilir.
export function MagazaDegerlendirmeFormu({
  magazaId,
  magazaAd,
  mevcutPuan,
  mevcutYorum,
  ...
  async function gonder(e: React.FormEvent) {
    ...
    const res = await fetch("/api/magaza-degerlendirme", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ magazaId, puan, yorum: yorum.trim() }),
    });
