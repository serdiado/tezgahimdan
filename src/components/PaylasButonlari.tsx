...
// WhatsApp logosu (lucide'de yok) - kucuk inline SVG. Export edilir - MagazaHero.tsx
// gibi baska yerlerde de (magaza sahibine dogrudan yazma butonu) ayni ikon kullanilir.
export function WhatsappIkon({ className }: { className?: string }) {
  return (
